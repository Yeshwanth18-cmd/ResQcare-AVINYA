...
const GoogleCalendarConnect: React.FC = () => {
    ...
    if (isConnected) {
        return (
            <div className="flex items-center justify-between p-4 bg-success-light text-success-text rounded-lg">
    ...
    return (
        <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold py-3 px-4 rounded-lg transition-colors h-[48px] focus:outline-none focus:ring-2 focus:ring-ring"
        >
            <IconGoogle className="w-6 h-6" />
